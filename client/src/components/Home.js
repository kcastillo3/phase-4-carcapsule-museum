...
const Home = () => {
  return (
    <div className="home-container">
      ...
      <img className="museum-image" src="https://res.cloudinary.com/doyp4tk82/image/upload/v1710902107/Black_Elegant_Collage_Artist_Portfolio_Presentation_e3ldov.jpg" alt="Car Capsule Museum" />

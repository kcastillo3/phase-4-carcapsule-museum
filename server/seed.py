...
def seed_database():
    # Create sample users
    user1 = Users(email='user1@example.com', username='user1', password_hash='password1')
    user2 = Users(email='user2@example.com', username='user2', password_hash='password2')
    
   # List of cars with their attributes
    cars_data = [
       {
      id: 1,
      year: 1970,
    ...
    review1 = Reviews(user=user1, car=car1, rating=5, content='Review content for Car1 by User1')
    review2 = Reviews(user=user2, car=car2, rating=4, content='Review content for Car2 by User2')
